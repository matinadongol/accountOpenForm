...
require $_SERVER['DOCUMENT_ROOT'].'/accountOpenForm/class/firstSection.php';
require $_SERVER['DOCUMENT_ROOT'].'/accountOpenForm/class/beneficialowner.php';
require $_SERVER['DOCUMENT_ROOT'].'/accountOpenForm/class/correspondenceAddress.php';
require $_SERVER['DOCUMENT_ROOT'].'/accountOpenForm/class/permanentAddress.php';
require $_SERVER['DOCUMENT_ROOT'].'/accountOpenForm/class/certificateDetails.php';
require $_SERVER['DOCUMENT_ROOT'].'/accountOpenForm/class/occupationDetails.php';
require $_SERVER['DOCUMENT_ROOT'].'/accountOpenForm/class/bankDetails.php';
require $_SERVER['DOCUMENT_ROOT'].'/accountOpenForm/class/nomineeDetails.php';
require $_SERVER['DOCUMENT_ROOT'].'/accountOpenForm/class/guardianDetails.php';
require $_SERVER['DOCUMENT_ROOT'].'/accountOpenForm/class/otherDocuments.php';
require $_SERVER['DOCUMENT_ROOT'].'/accountOpenForm/class/form.php';
...
if(isset($_POST)){
    ...
    $nomineeDetailsData['nomineeName'] = !empty($_POST['nomineeName']) ? sanitize($_POST['nomineeName']) : null;
    ...
    $guardianDetailsData['guardian_citizenshipIssueDistrict'] = !empty($_POST['guardian_citizenshipIssueDistrict']) ? sanitize($_POST['guardian_citizenshipIssueDistrict']) : null;
