...
function isAMinor() {
    ...
    document.getElementById("guardian_citizenshipIssueDistrict").classList.add("validations");
...
function notAMinor() {
    ...
    document.getElementById("guardian_citizenshipIssueDistrict").classList.remove("validations");
    ...
    document.getElementById("applicantCitizenshipBackPhoto").classList.add("validations");
}

function isANominee() {
    document.getElementById('nomineeDetail').style.display = 'block';
    document.getElementById("nomineeName").classList.add("validations");
    ...
    document.getElementById("nomineeSignature").classList.add("validations");
...
document.getElementById('nomineeDetail').style.display = 'none';

function notANominee() {
    document.getElementById('nomineeDetail').style.display = 'none';
    document.getElementById("nomineeName").classList.remove("validations");
