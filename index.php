...
require $_SERVER['DOCUMENT_ROOT'].'/accountOpenForm/class/bank.php';
require $_SERVER['DOCUMENT_ROOT'].'/accountOpenForm/class/bankAccountType.php';
require $_SERVER['DOCUMENT_ROOT'].'/accountOpenForm/class/branch.php';
require $_SERVER['DOCUMENT_ROOT'].'/accountOpenForm/class/businessType.php';
require $_SERVER['DOCUMENT_ROOT'].'/accountOpenForm/class/district.php';
require $_SERVER['DOCUMENT_ROOT'].'/accountOpenForm/class/gender.php';
require $_SERVER['DOCUMENT_ROOT'].'/accountOpenForm/class/income.php';
require $_SERVER['DOCUMENT_ROOT'].'/accountOpenForm/class/occupationType.php';;
require $_SERVER['DOCUMENT_ROOT'].'/accountOpenForm/class/province.php';
require $_SERVER['DOCUMENT_ROOT'].'/accountOpenForm/class/referenceDocument.php';
require $_SERVER['DOCUMENT_ROOT'].'/accountOpenForm/class/title.php';
require $_SERVER['DOCUMENT_ROOT'].'/accountOpenForm/class/zone.php';
...
<div class="container">
    <form id="regForm" action="process\form.php" method="post" enctype="multipart/form-data">
        ...
        <div class="tab">
            ...
            <div id="nomineeDetail">
                <div class="scrollsection">
                    <div class="row mb-4">
                        <div class="col-lg-6">
                            <p class="font-22"><b>Name English <br> नाम <span class="red">*</span></b></p>
                            <input type="text" class="inputTextField " name="nomineeName" id="nomineeName">
                        </div>
                        <div class="col-lg-6">
                        ...
                        ?>
                            ...
                            ?>
                                ...
                                <input type="text" class="guardianIssuedDistrict-selected "
                                    name="guardian_citizenshipIssueDistrict" placeholder="Select District"
                                    id="guardian_citizenshipIssueDistrict" readonly>
